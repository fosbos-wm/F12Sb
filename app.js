...
const LERNSTAND_DEFAULTS = [
  {
        ...
        "description": "4 K-Prim-Aufgaben (je 5 Aussagen richtig/falsch) und 2 offene Fragen zu den Fallbeispielen „Lukas“, „Petra“ und „Judith“.",
        "tasks": [
            {
                "id": "kprim1",
                "label": "K-Prim 1 – Merkmale des Entwicklungsbegriffs",
                "points": 3,
                "prompt": "K-Prim-Aufgabe: Beurteilen Sie JEDE der folgenden fünf Aussagen einzeln als richtig (R) oder falsch (F). Schreiben Sie zu jeder Aussage R oder F.\n\na) Entwicklung bezeichnet eine gerichtete, zeitlich geordnete Reihe von Veränderungen des Erlebens und Verhaltens.\nb) Die Reihenfolge der Entwicklungsveränderungen ist prinzipiell umkehrbar.\nc) Entwicklungsveränderungen lassen sich bestimmten Altersspannen zuordnen (Lebensalterbezogenheit).\nd) Entwicklung bezieht sich ausschließlich auf die Kindheit und endet mit dem Erreichen des Erwachsenenalters.\ne) Die einzelnen Veränderungen im Entwicklungsverlauf treten unabhängig voneinander auf.",
                "solution": "a) R – Kernaussage der Definition (Hobmair).\nb) F – die Reihenfolge ist gerade NICHT umkehrbar, z. B. krabbeln Kinder, bevor sie gehen können.\nc) R – das nennt man Lebensalterbezogenheit.\nd) F – Entwicklung ist ein lebensumfassender Prozess (vgl. Lernbereichstitel 12.1) und endet nicht mit dem Erwachsenenalter.\ne) F – die Veränderungen bilden untereinander einen Zusammenhang und bauen aufeinander auf (z. B. Strampeln, Kriechen, Gehen).\nRichtig sind: a, c (2 von 5 Aussagen)."
            },
            {
                "id": "kprim2",
                "label": "K-Prim 2 – Die drei Entwicklungsbedingungen",
                "points": 3,
                "prompt": "K-Prim-Aufgabe: Beurteilen Sie JEDE der folgenden fünf Aussagen einzeln als richtig (R) oder falsch (F).\n\na) Mit „Anlage“ wird die genetische Ausstattung eines Menschen bezeichnet, die bei der Befruchtung festgelegt wird.\nb) Die vier Bereiche der Umwelt sind die natürliche, kulturelle, ökonomische und soziale Umwelt.\nc) Selbststeuerung bedeutet, dass der Mensch ausschließlich passiv auf Umwelteinflüsse reagiert.\nd) Anlage, Umwelt und Selbststeuerung wirken unabhängig voneinander und beeinflussen sich nicht gegenseitig.\ne) Genetische Faktoren sind u. a. für sensible Phasen verantwortlich, in denen bestimmte Verhaltensweisen und Persönlichkeitsmerkmale optimal erworben werden können.",
                "solution": "a) R.\nb) R – natürliche, kulturelle, ökonomische, soziale Umwelt.\nc) F – der Mensch ist als aktives Wesen zu verstehen, das „von sich aus“ Entwicklungsprozesse herbeiführt.\nd) F – die drei Bedingungen stehen in Wechselbeziehung zueinander und beeinflussen sich gegenseitig.\ne) R.\nRichtig sind: a, b, e (3 von 5 Aussagen)."
            },
            {
                "id": "kprim3",
                "label": "K-Prim 3 – Entwicklungsfördernde und -hemmende Erziehungseinflüsse",
                "points": 3,
                "prompt": "K-Prim-Aufgabe: Beurteilen Sie JEDE der folgenden fünf Aussagen einzeln als richtig (R) oder falsch (F).\n\na) Sichere Bindung, hohe Wertschätzung und autoritative Erziehung zählen zu den entwicklungsfördernden Erziehungseinflüssen.\nb) Autoritäre Erziehung mit engen, sachlich unbegründeten Vorgaben gilt als besonders entwicklungsfördernd.\nc) Laissez-faire-Erziehung sowie Überbehütung zählen zu den entwicklungshemmenden Fehlformen der Erziehung.\nd) Eine Entwicklungsstörung hat so gut wie immer nur eine einzige Ursache.\ne) Entwicklungsstörungen können sowohl ererbt bzw. organisch bedingt sein als auch auf Umwelteinflüsse zurückgehen.",
                "solution": "a) R.\nb) F – autoritäre Erziehung mit unbegründeten Vorgaben („weil ich es dir sage“) ist von der fördernden AUTORITATIVEN Erziehung mit sachlich begründeten Regeln zu unterscheiden.\nc) R.\nd) F – meist wirken mehrere Ursachen im Zusammenspiel.\ne) R.\nRichtig sind: a, c, e (3 von 5 Aussagen)."
            },
            {
                "id": "kprim4",
                "label": "K-Prim 4 – Zusammenwirken der Bedingungen am Fall „Judith“",
                "points": 3,
                "prompt": "K-Prim-Aufgabe zum Fallbeispiel „Judith – ein Leben für den Schachsport“: Beurteilen Sie JEDE der folgenden fünf Aussagen einzeln als richtig (R) oder falsch (F).\n\na) Judiths mathematisch-logische Begabung lässt sich als Hinweis auf einen Anlagefaktor deuten, da ihr Vater Mathematikprofessor ist.\nb) Die Anlage entfaltet sich automatisch in vollem Umfang, unabhängig von Umwelteinflüssen.\nc) Ohne Judiths eigene Motivation (Selbststeuerung) hätte sich ihre Begabung vermutlich nicht in diesem Ausmaß entfalten können.\nd) Die gesellschaftliche Anerkennung, die Judith durch das Schachspiel erhielt, zeigt, dass die Selbststeuerung unabhängig von der Umwelt wirkt.\ne) Anlage, Umwelt und Selbststeuerung stehen bei Judiths Entwicklung in wechselseitiger Abhängigkeit zueinander.",
                "solution": "a) R – so die Argumentation der Lösungsskizze.\nb) F – das angelegte Potenzial muss erst durch entsprechende Umwelteinflüsse entfaltet werden.\nc) R.\nd) F – das Beispiel zeigt im Gegenteil die Abhängigkeit/Wechselwirkung zwischen Selbststeuerung und Umwelt (Anerkennung von außen stützt die Motivation).\ne) R – das ist die Kernaussage zum „Zusammenspiel der Entwicklungsbedingungen“.\nRichtig sind: a, c, e (3 von 5 Aussagen)."
            },
            {
                "id": "offen1",
...
async function submitLernstand(taskId,attempt){
  ...
  if(t.tasks.some(q=>!answers[q.id])){toast(`Bitte beantworte alle ${t.tasks.length} Kompetenzaufgaben.`);return}
