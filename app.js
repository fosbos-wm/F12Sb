  ...
  <section class="card" style="margin-top:20px">
    ...
    <div class="grid grid-3" style="margin-top:14px">
      ...
      <div class="card" style="background:#f5f7f8">
        ...
        <p style="font-size:13px;color:var(--muted);margin:8px 0 0">Im Kern geht es fast immer um den Wunsch, sich JETZT gut zu fühlen – auf Kosten von später. Häufige Gründe dahinter: Angst zu versagen oder nicht gut genug zu sein (Perfektionismus), das Gefühl, die Aufgabe von außen aufgezwungen zu bekommen, oder schlicht, dass unklar ist, wie überhaupt anzufangen ist. Aufschieben ist also ein (unbewusster) Versuch, sich selbst vor einem unangenehmen Gefühl zu schützen.</p>
      </div>
      <div class="card" style="background:#f5f7f8">
...
function updateProkResult(){
  ...
  if(!prokSelectedZiel){el.innerHTML="";return}
  const tips=PROK_ZIELE[prokSelectedZiel]||[];
  el.innerHTML=`<div class="notice"><strong>${prokSelectedGefuehl?`Von „${esc(prokSelectedGefuehl)}“ zu „${esc(prokSelectedZiel)}“`:`Um „${esc(prokSelectedZiel)}“ zu erzeugen`}</strong><ul style="margin:8px 0 0;padding-left:18px">${tips.map(t=>`<li>${esc(t)}</li>`).join("")}</ul></div>`;
}
