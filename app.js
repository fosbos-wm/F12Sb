...
async function openResilienzSchatzkiste(){
 const favorites=await getMyResilienzSchaetze();
 const cards=favorites.map(f=>{const d=resilienzSkillData(f.skillId);return`<div class="card res-card"style="position:relative;cursor:pointer"onclick="startResilienzSkill('${f.skillId}')">
