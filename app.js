...
const LERNSTAND_DEFAULTS = [
  {
    ...
    "description": "4 K-Prim-Aufgaben (je 5 Aussagen zum Ankreuzen) und 2 offene Fragen zu den Fallbeispielen „Lukas“, „Petra“ und „Judith“.",
    "tasks": [
      {
        "id": "kprim1",
        "type": "kprim",
      ...
      },
      {
        ...
        "points": 3,
        "intro": "Beurteilen Sie jede der folgenden Aussagen zu Erziehungseinflüssen. Setzen Sie ein Häkchen NUR bei den Aussagen, die Sie für RICHTIG halten.",
        "statements": [
          {
            "text": "Sichere Bindung, hohe Wertschätzung und autoritative Erziehung zählen zu den entwicklungsfördernden Erziehungseinflüssen.",
            "correct": true,
            "explain": ""
          },
          {
            "text": "Autoritäre Erziehung mit engen, sachlich unbegründeten Vorgaben gilt als besonders entwicklungsfördernd.",
            "correct": false,
            "explain": "Autoritäre Erziehung mit unbegründeten Vorgaben („weil ich es dir sage“) ist von der fördernden AUTORITATIVEN Erziehung mit sachlich begründeten Regeln zu unterscheiden."
          },
          {
            "text": "Laissez-faire-Erziehung sowie Überbehütung zählen zu den entwicklungshemmenden Fehlformen der Erziehung.",
            "correct": true,
            "explain": ""
          },
          {
            "text": "Eine Entwicklungsstörung hat so gut wie immer nur eine einzige Ursache.",
            "correct": false,
            "explain": "Meist wirken mehrere Ursachen im Zusammenspiel."
          },
          {
            "text": "Entwicklungsstörungen können sowohl ererbt bzw. organisch bedingt sein als auch auf Umwelteinflüsse zurückgehen.",
            "correct": true,
            "explain": ""
          }
        ],
...
function openLernstandResult(id){
  ...
  }).join("")}<div class="form-actions"><button class="secondary" onclick="closeModal()">Schließen</button></div>`)});
}
